      ...
      >
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <motion.span
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/95 border border-rcn-accent text-rcn-text text-sm font-medium shadow-sm"
          ...
          <div className="max-w-2xl">
            ...
            >
              Referrals that move as <span className="text-rcn-brand-light">fast as care demands</span>
            </motion.h1>
            <motion.p
            ...
            <motion.div className="flex flex-wrap gap-3 justify-center" variants={heroItemVariants}>
              <CustomNextLink href="/staff-portal/inbox" variant="primary" size="lg" className="inline-flex">
                Start Coordinating
