  ...
  return (
    <div className="max-w-[1280px] mx-auto  ">
      ...
      <nav className="md:sticky top-[5px] z-20 mb-3.5">
        <div className="bg-gradient-to-b from-rcn-brand to-rcn-brand-light text-white border border-white/14 rounded-2xl shadow-rcn p-3">
          <div className="flex items-center gap-3 flex-wrap overflow-x-auto">
            {[
              ...
              <a
                key={item.id}
                href={`#${item.id}`}
                className="inline-flex items-center text-white font-black text-[13px] px-3 py-2 rounded-xl border border-transparent hover:bg-white/12 hover:border-white/16 transition-all whitespace-nowrap"
              >
                {item.label}
              </a>
            ))}
